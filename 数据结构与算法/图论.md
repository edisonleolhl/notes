...
- Output: A spanning tree T — a tree that connects all vertices — of minimum weight: 
  ...
  ![1540175416378](C:/Users/lhl/AppData/Roaming/Typora/typora-user-images/1540175416378.png)

### 预备知识

- 通过贪婪算法可以得到求最小生成树的一般方法（generic MST method）

- generic MST method维持了一个树A，A从一个顶点开始，直到长成MST，generic MST method每次会使A生长一条边，但会保持一个不变量：每次生长后得到的树A肯定是MST的一部分，把满足不变量条件的生长的这条边称为A的一条安全的边（safe edge）

- 割与割集（[Wikipedia](https://en.wikipedia.org/wiki/Cut_(graph_theory))）：
...
- example:
  ...
  ![1540028823881](C:/Users/lhl/AppData/Roaming/Typora/typora-user-images/1540028823881.png)
...
- Analysis:
  ...
  ![1540027886391](C:/Users/lhl/AppData/Roaming/Typora/typora-user-images/1540027886391.png)
  ...
  ![1540027905026](C:/Users/lhl/AppData/Roaming/Typora/typora-user-images/1540027905026.png)
